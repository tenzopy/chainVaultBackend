"""
Django settings for chainvault project.
...
SECRET_KEY = 'django-insecure-^6d-vb7bbcjsbb3@bibdr_iu%$qe=eiq47p2d$dy-!=pns*+ll'
...
WSGI_APPLICATION = 'chainvault.wsgi.application'
